...
export default function ZersuArenaPage() {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center text-white">
        <motion.button
          ...
          className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-bold text-xl shadow-[0_0_20px_rgba(124,58,237,0.5)] hover:shadow-[0_0_30px_rgba(124,58,237,0.8)] transition-shadow"
        >
          Enter ZERSU'S ARENA
        </motion.button>
      </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-[#121212]/90 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row z-10"
          >
            {/* Left Side - Character Image */}
            <div className="relative w-full md:w-2/5 h-64 md:h-auto overflow-hidden bg-gradient-to-b from-purple-900/40 to-black/60 group">
              ...
              <motion.img
                ...
                alt="Zersu Challenge Face"
                className="w-full h-full object-cover object-center md:object-top transform group-hover:scale-105 transition-transform duration-700"
              />
            ...
            <div className="flex-1 p-8 md:p-10 flex flex-col justify-center relative">
              ...
              >
                <button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-purple-900/20 transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 group">
                  <span
